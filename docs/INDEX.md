...
- `src/ciel_sot_agent/index_validator.py` — machine registry validator for path, reference, and placeholder coherence.
...
- The shell-level bridge to `ciel-omega-demo` is connected to `docs/CIEL_OMEGA_DEMO_INTEGRATION.md` and `integration/upstreams/ciel_omega_demo_shell_map.json`.
