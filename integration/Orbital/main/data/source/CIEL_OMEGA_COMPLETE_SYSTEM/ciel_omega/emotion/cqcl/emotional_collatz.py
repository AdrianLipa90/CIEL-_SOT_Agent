...
from ciel_omega.emotion.cqcl.cqcl_program import CQCL_Program, normalize_profile, stable_hash
from ciel_omega.emotion.cqcl.quantum_engine import CIEL_Quantum_Engine
...
class EmotionalCollatzEngine(CIEL_Quantum_Engine):
    ...
    def _execute_emotional_computation(self, program: CQCL_Program) -> Dict[str, Any]:
        from ciel_omega.mathematics.safe_operations import HeisenbergSoftClipper, heisenberg_soft_clip
