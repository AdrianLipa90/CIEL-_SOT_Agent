...
def recommend_control(final: dict) -> dict:
    ...
    if ci < 0.82 or err > 6.10 or (ci < 0.90 and err > 5.8):
        ...
        mode = "deep"
        notes = "Strong coherence and acceptable closure: allow deeper diagnostic/integration passes."
        dt_override = 0.022
        zeta_scale = 0.38
